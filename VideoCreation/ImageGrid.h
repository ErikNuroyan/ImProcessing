...
private:
	...
	void resize_once_expand(int n,cv::VideoWriter &v, const cv::Mat & upper, const cv::Mat & lower);
	void energy();
	void update_energy();
...
public:
	...
	void print_grid();
	void resize(int n_pixels,cv::VideoWriter &v,const cv::Mat & upper,const cv::Mat & lower);
